...
export async function criarCliente(cliente: Omit<Cliente, 'id' | 'data_cadastro'>): Promise<string> {
    try {
        const resposta = await fetch('api/cliente.php', {
            method: 'POST',
...
export async function atualizarCliente(cliente: Cliente): Promise<string> {
    try {
        const resposta = await fetch('api/cliente.php', {
            method: 'PUT',
            headers: { 'Content-Type': 'application/json' },
...
export async function excluirCliente(id: number): Promise<string> {
    try {
        const resposta = await fetch('api/cliente.php', {
            method: 'DELETE',
            headers: { 'Content-Type': 'application/json' },
