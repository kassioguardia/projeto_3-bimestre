...
export async function criarPecaCliente(pecaCliente: Omit<PecaCliente, 'id' | 'data_solicitacao'>): Promise<string> {
    try {
        const resposta = await fetch('api/peca_cliente.php', {
            method: 'POST',
...
export async function atualizarPecaCliente(pecaCliente: PecaCliente): Promise<string> {
    try {
        const resposta = await fetch('api/peca_cliente.php', {
            method: 'PUT',
            headers: { 'Content-Type': 'application/json' },
...
export async function excluirPecaCliente(id: number): Promise<string> {
    try {
        const resposta = await fetch('api/peca_cliente.php', {
            method: 'DELETE',
            headers: { 'Content-Type': 'application/json' },
